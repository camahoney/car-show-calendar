...
export function EventExplorer({ initialEvents }: EventExplorerProps) {
    ...
    return (
        <>
            {/* Search & Toggle Bar */}
            <div className="ultra-glass p-2 rounded-2xl max-w-2xl mx-auto flex flex-col md:flex-row gap-2 mb-12 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300 relative z-30 focus-within:glow transition-all duration-500">
                <div className="relative flex-grow flex gap-2">
                    <div className="relative flex-grow">
                        <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-primary h-5 w-5 drop-shadow-[0_0_8px_rgba(239,68,68,0.5)]" />
                        <Input
                            placeholder="Search events, cities..."
                            className="h-12 pl-12 bg-transparent border-none text-lg focus-visible:ring-0 placeholder:text-muted-foreground/50 text-white"
                            value={searchTerm}
