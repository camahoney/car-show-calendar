...
export default function Error({
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4 text-center p-4">
            <h2 className="text-xl font-bold text-red-500">Something went wrong loading users!</h2>
            <p className="text-muted-foreground">{error.message || "Failed to load user management."}</p>
